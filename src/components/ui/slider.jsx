  ...
  return (<SliderPrimitive.Root
    ...
    >
      <SliderPrimitive.Track
        ...
        className={cn("bg-muted relative grow overflow-hidden rounded-full data-[orientation=horizontal]-4 data-[orientation=horizontal]-full data-[orientation=vertical]-full data-[orientation=vertical]-1.5",)}
      >
        <SliderPrimitive.Range
          data-slot="slider-range"
          className={cn("bg-primary absolute data-[orientation=horizontal]-full data-[orientation=vertical]-full",)}
        />
      </SliderPrimitive.Track>
      {Array.from({ length}, (_, index) => (<SliderPrimitive.Thumb
