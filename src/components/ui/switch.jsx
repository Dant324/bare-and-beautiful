  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          "bg-card dark-[state=unchecked]-card-foreground dark-[state=checked]-primary-foreground pointer-events-none block size-4 rounded-full ring-0 transition-transform data-[state=checked]-x-[calc(100%-2px)] data-[state=unchecked]:translate-x-0"
        )}
      />
    </SwitchPrimitive.Root>
  );
